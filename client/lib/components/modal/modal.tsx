...
import { addCategory } from "@/lib/store/institute/category/institute-category-slice"
import { ICategoryAddData } from "@/lib/store/institute/category/institute-category-types"
        ...
        <div className="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
          ...
          <form onSubmit={handleCategorySubmission} className="space-y-4">
            <div>
              ...
              <input name="categoryName" onChange={handleCategoryChange} type="text" id="website_url" className="w-full mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500" placeholder="Web Development" required />
            </div>
            <div>
              ...
              <textarea name="categoryDescription" onChange={handleCategoryChange} id="website_url" className="w-full mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500" placeholder="Web Development is related to web" required />
            </div>

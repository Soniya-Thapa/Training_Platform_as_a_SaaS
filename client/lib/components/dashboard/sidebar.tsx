...
function Sidebar() {
  // const sidebarDatas = [
  //   {
  //     linkTo: "/institute/dashboard",
  //     text:"Dashboard"
  //   },
  //   {
  //     linkTo: "/institute/dashboard/student",
  //     text:"Student"
  //   },
  //       {
  //     linkTo: "/institute/dashboard/teacher",
  //     text:"Teacher"
  //   }
  // ]
  return (
    <>
      <nav className="mt-5 px-2">
        ...
        <Link href="#" className="mt-1 group flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
          <svg className="mr-3 h-6 w-6 text-gray-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
